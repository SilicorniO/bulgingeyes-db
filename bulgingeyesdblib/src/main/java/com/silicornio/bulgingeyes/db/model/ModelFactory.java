...
//		Gson gson = new Gson();
	...
	public static ModelObjectAttribute findAttribute(String sAttribute, ModelObject[] models){
		...
		if(aSAttribute.length!=2){
			JEL.e("ERROR syntax in attribute reference: " + sAttribute);
			return null;
		}
		...
		if(m!=null){
			...
			if(ma!=null){
				...
				JEL.e("ERROR finding attribute reference: " + sAttribute);
				return null;
			}
		}
		
		//not found
		JEL.e("ERROR finding object attribute reference: " + sAttribute);
		return null;
	}
